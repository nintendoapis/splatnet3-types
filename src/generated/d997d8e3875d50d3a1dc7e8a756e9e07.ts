...
import { Badge, Color, CurrentPlayer, Gear, GearPower, Image, Nameplate, NameplateBackground, PlayHistory, Player, SpecialWeapon, SubWeapon, Weapon, WeaponCategory, WeaponCategoryUtilRatio, WeaponHistory, WeaponHistoryConnection, WeaponUtilRatio, XMatchMax, XMatchSeasonHistory, XMatchSeasonHistoryConnection, XMatchSeasonHistoryEdge, XRankingSeason } from '../types.js';

/**
 * d997d8e3875d50d3a1dc7e8a756e9e07 HistoryRecordRefetchQuery
 *
 * query HistoryRecordRefetchQuery
 *
 * Generated 16/03/2023 from SplatNet 3 3.0.0-6049221b.
 */
interface HistoryRecordRefetchQuery_d997d8e {
...
export default HistoryRecordRefetchQuery_d997d8e;
export { HistoryRecordRefetchQuery_d997d8e };
