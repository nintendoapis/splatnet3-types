 ...
 */
interface refetchableCoopHistory_coopResultQuery_a5692cf {
...
export default refetchableCoopHistory_coopResultQuery_a5692cf;
export { refetchableCoopHistory_coopResultQuery_a5692cf };
